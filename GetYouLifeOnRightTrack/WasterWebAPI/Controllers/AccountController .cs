...
namespace WasterWebAPI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        */
        ...
        public async Task<ActionResult> Register(RegisterModel model, bool captchaValid, string captchaErrorMessage)
        {
            if (!captchaValid)
            {
                ModelState.AddModelError(string.Empty, captchaErrorMessage);
            }
