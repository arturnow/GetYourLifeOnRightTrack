...
$.validator.addMethod("dategreaterthannow", function (value, element, params) {
    console.log('a taki śmietnik');
...
*/
$.validator.unobtrusive.adapters.add("dategreaterthannow", ['mindate'], function (options) {
    console.log('a taki śmietnik');
//    options.rules["dategreaterthannow"] = "#" + options.params.otherpropertyname;
    options.rules["dategreaterthannow"] = options.params.mindate;

    options.messages["dategreaterthannow"] = options.message;
});
